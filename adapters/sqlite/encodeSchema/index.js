...
var encodeFTSTable = function ({
  ...
  return "create virtual table \"".concat(ftsTableName, "\" using fts4(").concat(columnsSQL, ");");
};
...
var encodeAddColumnsMigrationStep = function ({
  ...
  return columns.map(function (column) {
    ...
    (0, _common.invariant)(!column.isFTS, '[DB][Worker] Support for migrations with isFTS is still to be implemented');

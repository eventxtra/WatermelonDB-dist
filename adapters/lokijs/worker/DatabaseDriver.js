...
var DatabaseDriver = /*#__PURE__*/function () {
      ...
      if (dbVersion === schemaVersion) {// All good!
        ...
        if (0 === dbVersion) {
          ...
          if (0 < dbVersion && dbVersion < schemaVersion) {
            ...
            _logger.default.warn('[Loki] Database has newer version than app schema. Resetting database.');
  ...
  _proto._warnAboutLackingFTSSupport = function _warnAboutLackingFTSSupport(columns) {
    if (columns.some(function (column) {
      ...
      _logger.default.warn('[DB][Worker] LokiJS support for FTS is still to be implemented');
    }
  };
